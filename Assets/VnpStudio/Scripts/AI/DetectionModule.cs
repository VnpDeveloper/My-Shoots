...
using VnpStudio.Game;

namespace VnpStudio.AI
{
    public class DetectionModule : MonoBehaviour
    {
        [Tooltip("Điểm mốc để bắt đầu cho phạm vi phát hiện mục tiêu bằng AI")]
        public Transform DetectionSourcePoint;

        [Tooltip("Khoảng cách tối đa mà có thể phát hiện mục tiêu")]
        public float DetectionRange = 20f;

        [Tooltip("Khoảng cách tối đa mà có thể tấn công mục tiêu")]
        public float AttackRange = 10f;

        [Tooltip("Khoảng thời gian từ bỏ tìm kiếm kể từ khi không thấy mục tiêu nữa")]
